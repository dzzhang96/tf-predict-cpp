...
def _create_conv_net(X, image_width, image_height, image_channel, phase, drop_conv, n_class=1):
    ...
    conv1_1 = tf.contrib.layers.batch_norm(conv1_1, center=True, scale=True, is_training=phase)
    ...
    conv1_2 = tf.contrib.layers.batch_norm(conv1_2, center=True, scale=True, is_training=phase)
    ...
    conv2_1 = tf.contrib.layers.batch_norm(conv2_1, center=True, scale=True, is_training=phase)
    ...
    conv2_2 = tf.contrib.layers.batch_norm(conv2_2, center=True, scale=True, is_training=phase)
    ...
    conv3_1 = tf.contrib.layers.batch_norm(conv3_1, center=True, scale=True, is_training=phase)
    ...
    conv3_2 = tf.contrib.layers.batch_norm(conv3_2, center=True, scale=True, is_training=phase)
    ...
    conv4_1 = tf.contrib.layers.batch_norm(conv4_1, center=True, scale=True, is_training=phase)
    ...
    conv4_2 = tf.contrib.layers.batch_norm(conv4_2, center=True, scale=True, is_training=phase)
    ...
    conv5_1 = tf.contrib.layers.batch_norm(conv5_1, center=True, scale=True, is_training=phase)
    ...
    conv5_2 = tf.contrib.layers.batch_norm(conv5_2, center=True, scale=True, is_training=phase)
    ...
    conv7_1 = tf.contrib.layers.batch_norm(conv7_1, center=True, scale=True, is_training=phase)
    ...
    conv7_2 = tf.contrib.layers.batch_norm(conv7_2, center=True, scale=True, is_training=phase)
    ...
    conv9_1 = tf.contrib.layers.batch_norm(conv9_1, center=True, scale=True, is_training=phase)
    ...
    conv9_2 = tf.contrib.layers.batch_norm(conv9_2, center=True, scale=True, is_training=phase)
    ...
    conv11_1 = tf.contrib.layers.batch_norm(conv11_1, center=True, scale=True, is_training=phase)
    ...
    conv11_2 = tf.contrib.layers.batch_norm(conv11_2, center=True, scale=True, is_training=phase)
    ...
    conv13_1 = tf.contrib.layers.batch_norm(conv13_1, center=True, scale=True, is_training=phase)
    ...
    conv13_2 = tf.contrib.layers.batch_norm(conv13_2, center=True, scale=True, is_training=phase)
...
class unet2dModule(object):
    ...
    def __init__(self, image_height, image_width, channels=3, costname="dice coefficient"):
    ...
    def train(self, train_images, train_lanbels, model_path, logs_path, learning_rate,
        ...
        for i in range(train_epochs):
            ...
            for num in range(len(batch_xs_path)):
                ...
                #print(batch_xs_path[num][0])
                #img = cv2.imread('Segment/Image/25.bmp')
